...
void extractBalanceChange(couchit::CouchDB &orderDB, const couchit::Value &tradeDoc, IMoneySrvClient::BalanceChange &tdata, OrderDir::Type dir,const MarketConfig &mcfg);
